...
export const SET_DESIGN_MODE = 'SET_DESIGN_MODE' as const;
...
export function setDesignMode(value: boolean) {
  return {
    designMode: value,
    type: SET_DESIGN_MODE,
  };
}
export type setDesignMode = ReturnType<typeof setDesignMode>;